...
import org.mikem.tumblrj.api.model.TumbleFeed;
...
public class TumbleLogReaderTest {
	...
	public void readVideo() throws Exception {
        ...
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/video.xml");
	...
	public void readPhoto() throws Exception {
		SAXReader reader = new SAXReader();
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/photos.xml");
	...
	public void readRegular() throws Exception {
		SAXReader reader = new SAXReader();
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/regular.xml");
	...
	public void readQuote() throws Exception {
		SAXReader reader = new SAXReader();
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/quote.xml");
	...
	public void readConversation() throws Exception {
		SAXReader reader = new SAXReader();
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/conversation.xml");
	...
	public void readLinks() throws Exception {
		SAXReader reader = new SAXReader();
        Document document = reader.read("test/org/mikem/tumblrj/tests/resources/links.xml");
